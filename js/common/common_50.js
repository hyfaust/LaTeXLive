...
var scriptLoader = {
  script_list: {
    ...
    latex: ["<script src='../lib/tippy/popper.min.js'></script>",
      "<script src='../js/tippy-bundle.umd.min.js'></script>",
      "<script src='../lib/caret/caret.js'></script>",
      "<script src='../js/local-data.js'></script>",
      "<script src='../lib/latex.bundle.min.js'></script>"],
  ...
  googleads: function () {
    const analyticsId = Config[Environment].Analytics && Config[Environment].Analytics.GoogleUA;
    if (Environment != "development" && analyticsId) {
      document.writeln("<script async src='https://www.googletagmanager.com/gtag/js?id=" + analyticsId + "'></script>");
      document.writeln("  <script>");
      ...
      document.writeln("");
      document.writeln("    gtag('config', '" + analyticsId + "');");
      document.writeln("  </script>");
    }
  },
